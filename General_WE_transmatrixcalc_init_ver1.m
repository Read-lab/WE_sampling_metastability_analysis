function General_trans_051117_NANOG_HPC_fullspec_f50_full_parallel(vorloops,loops2,temp_save_location,num_nodes,ReplicasRequired,name,tau,tau_name,final_save_location,species,bash_clump,rstart,BNG_netfile_name)
...
unix([ ' > ' temp_save_location '/finished.txt']);
    ...
    temp{25} = sprintf('PREV_FILE="BNG_net_files/%s"',BNG_netfile_name);
